...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ShitcoinUnits::SeparatorStyle separators=ShitcoinUnits::separatorStandard) const;
