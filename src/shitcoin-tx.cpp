...
static void SetupShitcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shitcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shitcoin-tx [options] <hex-tx> [commands]  Update hex-encoded shitcoin transaction\n" +
            "or:     shitcoin-tx [options] -create [commands]   Create hex-encoded shitcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded shitcoin transaction
