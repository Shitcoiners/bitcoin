    ...
    mapper(0)
{
    ...
    ui->shitcoinAtStartup->setToolTip(ui->shitcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->shitcoinAtStartup->setText(ui->shitcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openShitcoinConfButton->setToolTip(ui->openShitcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ShitcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->shitcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openShitcoinConfButton_clicked()
{
