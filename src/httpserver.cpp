// Copyright (c) 2015-2018 The Shitcoin Core developers
...
{
    RenameThread("shitcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/shitcoin/shitcoin/pull/6990)
