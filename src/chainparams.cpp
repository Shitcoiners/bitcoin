...
{
    const char* pszTimestamp = "Forbes 26/12 Another shitcoin is created";
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1609035280; // 2020

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        // FUCK
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 0; // November 15th, 2016.
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1609035280; // 2020

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00"); //0x0000000000000000000000000000000000000000028822fef1c230963535a90d
        ...
        nDefaultPort = 4200; // P2P port // RPC 4201
		...
		*/
        ...
        //vSeeds.emplace_back("seed.shitcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        ...
        bech32_hrp = "sht"; // apparently segwit prefix
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.shitcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.shitcoin.sprovoost.nl");
